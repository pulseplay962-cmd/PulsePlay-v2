    ...
    <section className="mt-20">
      ...
      <div className="mb-10">
        ...
        <p className="mt-3 text-slate-400 max-w-2xl">
          Catch the latest gameplay, streams, highlights, and PulsePlay
          community moments.
        </p>
      </div>
          ...
          {videos.map((video) => (
            ...
            >
              {video.thumbnail ? (
                ...
                <div className="h-52 rounded-xl mb-5 flex items-center justify-center bg-black/40 border border-white/10 text-slate-500">
                  No Thumbnail
                </div>
              )}

              {video.platform && (
                <div className="flex items-center gap-2 mb-3 text-sm text-cyan-400 font-bold">
                  <span className="pp-live-dot" />
                  {video.platform}
                </div>
              )}
